// McKinsey-style CV components
// Each function renders one section type from structured data.
//
// ============================================================================
// TWEAKABLE SPACING CONSTANTS — adjust these to control the overall feel
// ============================================================================
...
#let BULLET-SPACE-BETWEEN = 3pt    // vertical gap between bullets
...
// ============================================================================
// Section header — UPPERCASE with thin rule
// ============================================================================
...
// ============================================================================
// Contact bar — single centred line with pipe separators
// ============================================================================
...
#let experience-entry(company, roles, location: none) = {
  ...
  for role in roles {
    ...
    // Title | Department — right-aligned date
    grid(
      ...
      align(right, text(role.period, size: SMALL-SIZE, fill: CLR-MUTED)),
    )
...
#let education-entry(entry) = {
  grid(
    ...
    align(right, text(entry.period, size: SMALL-SIZE, fill: CLR-MUTED)),
  )
  v(ENTRY-SPACE-BELOW)
}

// ============================================================================
// Skills — category bold, then sub-groups indented
// ============================================================================
...
// ============================================================================
// Certifications — compact dash list
// ============================================================================
